...
# MAGIC %sql
# MAGIC DROP DATABASE IF EXISTS jul_lakehouse.bronze CASCADE;
# MAGIC DROP DATABASE IF EXISTS jul_lakehouse.silver CASCADE; 
# MAGIC DROP DATABASE IF EXISTS jul_lakehouse.gold CASCADE;
...
# MAGIC %sql
# MAGIC USE CATALOG jul_lakehouse;
# MAGIC
# MAGIC CREATE DATABASE IF NOT EXISTS jul_lakehouse.bronze;
# MAGIC CREATE DATABASE IF NOT EXISTS jul_lakehouse.silver;
# MAGIC CREATE DATABASE IF NOT EXISTS jul_lakehouse.gold;
# MAGIC
...
# MAGIC
# MAGIC We add for each table an incremental surrogate key together with technical fields columns. _tf_ technical field, commence par _ ne doit pas être utiliser
...
# MAGIC
# MAGIC     -- Technical columns, technique de BI SCD2
...
# MAGIC     number STRING,
# MAGIC     color STRING,
# MAGIC     cost DECIMAL(38,6),
# MAGIC     price DECIMAL(38,6),
# MAGIC     size STRING,
...
# MAGIC   prod_number STRING,
# MAGIC   prod_color STRING,
# MAGIC   prod_cost DECIMAL(38,6),
# MAGIC   prod_price DECIMAL(38,6),
...
# MAGIC   _tf_update_date)
# MAGIC
# MAGIC VALUES (-9, 0, 'N/A', 'N/A', 'N/A', 0, 0, 'N/A', 0,-9, current_timestamp(), current_timestamp());
...
# MAGIC
# MAGIC   -- Attributes
# MAGIC   cat_product_category_id INT,
# MAGIC   cat_name STRING,
# MAGIC
# MAGIC   -- Technical columns
# MAGIC   _tf_create_date TIMESTAMP,
# MAGIC   _tf_update_date TIMESTAMP
...
# MAGIC   cat_product_category_id,
# MAGIC   cat_name,
# MAGIC   _tf_create_date,
# MAGIC   _tf_update_date)
# MAGIC
# MAGIC VALUES (-9, 0, 'N/A', current_timestamp(), current_timestamp());
